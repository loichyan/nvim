...
vim.api.nvim_create_autocmd("LspAttach", { callback = function(args) Meow.keyset(args.buf, {
    ...
    { "<Leader>ld", function() require("fzf-lua").lsp_definitions() end,     desc = "List definitions"      },
    { "<Leader>lD", function() require("fzf-lua").lsp_typedefs() end,        desc = "List type definitions" },
