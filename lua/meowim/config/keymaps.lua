...
Meow.keymap({
  ...
  { '[b',                  function() require('meoline').goto_tab('left') end,                           desc = 'Buffer left'                       },
  { '[B',                  function() require('meoline').goto_tab(1) end,                                desc = 'Buffer leftmost'                   },
  { ']b',                  function() require('meoline').goto_tab('right') end,                          desc = 'Buffer right'                      },
  { ']B',                  function() require('meoline').goto_tab(-1) end,                               desc = 'Buffer rightmost'                  },
  { '<S-h>',               function() require('meoline').goto_tab('left') end,                           desc = 'Buffer left'                       },
  { '<S-l>',               function() require('meoline').goto_tab('right') end,                          desc = 'Buffer right'                      },

  { '<Leader>bh',          function() require('meoline').close_tab('left') end,                          desc = 'Close left buffers'                },
  { '<Leader>bl',          function() require('meoline').close_tab('right') end,                         desc = 'Close right buffers'               },
  { '<Leader>bo',          function() require('meoline').close_tab('other') end,                         desc = 'Close other buffers'               },
  ...
  { '<Leader>fw',          function() H.pick_word('current') end,                                        desc = 'Grep buffer <cword>'               },
  { '<Leader>fW',          function() H.pick_word('all') end,                                            desc = 'Grep workspace <cword>'            },
})
